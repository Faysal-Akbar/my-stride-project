...
const SingleProductDashboard = ({shoe}) => {
    ...
    return (
        ...
        <button className="btn bg-green-400 rounded-xl w-[100px]  mt-2 text-white">
            <Link to={``}>Edit</Link>
        </button> <br />
        <button onClick={handleDelete} className="btn bg-red-500 rounded-xl w-[100px] p-2 text-white">
            Delete
        </button>
        </div>
        </div>
